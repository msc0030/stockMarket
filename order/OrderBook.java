...
public class OrderBook {
	...
	public int calculateTransactionAmount(double price, ArrayList<Order> sellOrders, ArrayList<Order> buyOrders)
	{
		...
		buyers = getTotalSellAmount(sellOrders);
		sellers = getTotalBuyAmount(buyOrders);	
		return getTransaction(buyers, sellers);
	}

  	private int getTotalSellAmount(ArrayList<Order> sellOrders) {
    		int sellers = 0;
  	...
  	private int getTotalBuyAmount(ArrayList<Order> buyOrders) {
          	int buyers = 0;
  	...
  	private int getTransaction(int buyers, int sellers) {
  		int transactions = 0;
